...
class Image(models.Model):
    ...
    def __str__(self):
        out = str(self.datetime_published.day) + ':' + str(self.datetime_published.month) + ':' + str(self.datetime_published.year) + ' ' + str(self.datetime_published.hour) + ':' + str(self.datetime_published.minute)
        return out
